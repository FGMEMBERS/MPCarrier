...
#			"LOW", "VERY LOW"];
    ...
    setup: func(data) {
        ...
        setprop("/sim/current-view/x-offset-m",19.19);
        setprop("/sim/current-view/y-offset-m",8.43);
        setprop("/sim/current-view/z-offset-m",85.2431);
        setprop("/sim/current-view/default-field-of-view-deg",110);
